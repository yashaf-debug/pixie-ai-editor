    ...
    <div className="w-full max-w-6xl mx-auto flex flex-col items-center gap-6 animate-fade-in p-4">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
            <button
                ...
                className="bg-white p-6 rounded-lg border border-gray-200 text-left hover:border-blue-500 hover:ring-2 hover:ring-blue-200 transition-all duration-200 flex flex-col items-start"
            >
                ...
                <p className="text-gray-600 flex-grow">{t('businessHub.adCreative.desc')}</p>
                <span className="mt-4 text-blue-600 font-semibold">{t('businessHub.launchStudio')}</span>
            </button>
            ...
            >
                ...
                <p className="text-gray-600 flex-grow">{t('businessHub.productStudio.desc')}</p>
                 <span className="mt-4 text-blue-600 font-semibold">{t('businessHub.launchProductStudio')}</span>
            </button>
            ...
            >
                ...
                <p className="text-gray-600 flex-grow">{t('businessHub.contentPlan.desc')}</p>
                 <span className="mt-4 text-blue-600 font-semibold">{t('businessHub.generatePlan')}</span>
            </button>
        </div>
    </div>
  );
